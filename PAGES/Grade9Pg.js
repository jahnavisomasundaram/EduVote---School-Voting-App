...
function Grade9() {
    ...
    useEffect(() => {
        fetchGrade9Candidates();
    }, []);

    const fetchGrade9Candidates = async () => {
        try {
            const response = await fetch("http://localhost:5000/api/candidates/grade9");
    ...
    return (
        <div className="home-page">
            ...
            <div className="content">
                ...
                <h2>9th Grade:</h2>
                {candidates.length === 0 ? (
                    <p>No candidates found for Grade 9 Head</p>
                ) : (
