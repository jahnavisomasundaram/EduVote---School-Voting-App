...
function Grade8() {
    ...
    useEffect(() => {
        fetchGrade8Candidates();
    }, []);

    const fetchGrade8Candidates = async () => {
        try {
            const response = await fetch("http://localhost:5000/api/candidates/grade8");
    ...
    return (
        <div className="home-page">
            ...
            <div className="content">
                ...
                <h2>8th Grade:</h2>
                {candidates.length === 0 ? (
                    <p>No candidates found for Grade 8 house</p>
                ) : (
