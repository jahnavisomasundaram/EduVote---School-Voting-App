...
function Grade12() {
    ...
    useEffect(() => {
        fetchGrade12Candidates();
    }, []);

    const fetchGrade12Candidates = async () => {
        try {
            const response = await fetch("http://localhost:5000/api/candidates/grade12");
    ...
    return (
        <div className="home-page">
            ...
            <div className="content">
                ...
                <h2>12th Grade:</h2>
                {candidates.length === 0 ? (
                    <p>No candidates found for Grade 12 Head</p>
                ) : (
