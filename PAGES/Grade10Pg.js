...
function Grade10() {
    ...
    useEffect(() => {
        fetchGrade10Candidates();
    }, []);

    const fetchGrade10Candidates = async () => {
        try {
            const response = await fetch("http://localhost:5000/api/candidates/grade10");
    ...
    return (
        <div className="home-page">
            ...
            <div className="content">
                ...
                <h2>10th Grade:</h2>
                {candidates.length === 0 ? (
                    <p>No candidates found for Grade 10 Head</p>
                ) : (
