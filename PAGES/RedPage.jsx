...
function RedHouse() {
    ...
    const fetchRedCandidates = async () => {
        try {
            const response = await fetch("http://localhost:5000/api/candidates/red");
    ...
    return (
        <div className="home-page">
            ...
            <div className="content">
                <h1>House Captain</h1>
                <h2>Select for Red House:</h2>
                {candidates.length === 0 ? (
                    <p>No candidates found for Red house</p>
                ) : (
