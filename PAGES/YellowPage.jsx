...
function YellowHouse() {
    ...
    useEffect(() => {
        fetchYellowCandidates();
    }, []);

    const fetchYellowCandidates = async () => {
        try {
            const response = await fetch("http://localhost:5000/api/candidates/yellow");
    ...
    return (
        <div className="home-page">
            ...
            <div className="content">
                <h1>House Captain</h1>
                <h2>Select for Yellow House:</h2>
                {candidates.length === 0 ? (
                    <p>No candidates found for Yellow house</p>
                ) : (
