...
function Grade11() {
    ...
    useEffect(() => {
        fetchGrade11Candidates();
    }, []);

    const fetchGrade11Candidates = async () => {
        try {
            const response = await fetch("http://localhost:5000/api/candidates/grade11");
        ...
        <div className="home-page">
           <header className="header">
            ...
            <div className="content">
                ...
                <h2>11th Grade:</h2>
                {candidates.length === 0 ? (
                    <p>No candidates found for Grade 11 Head</p>
                ) : (
