...
function GreenHouse() {
    ...
    useEffect(() => {
        fetchGreenCandidates();
    }, []);

    const fetchGreenCandidates = async () => {
        try {
            const response = await fetch("http://localhost:5000/api/candidates/green");
    ...
    return (
        <div className="home-page">
            ...
            <div className="content">
                <h1>House Captain</h1>
                <h2>Select for Green House:</h2>
                {candidates.length === 0 ? (
                    <p>No candidates found for Green house</p>
                ) : (
